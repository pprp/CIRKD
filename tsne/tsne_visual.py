...
net1_embeddings = np.load(
    'seg_class_embed.npy')  # size: (sample_num, embedding_dim)
...
color_dict = {}
colors = [
    'black', 'red', 'gold', 'green', 'orange', 'pink', 'magenta', 'slategray',
    'greenyellow', 'lightgreen', 'brown', 'chocolate', 'mediumvioletred',
    'navy', 'lightseagreen', 'aqua', 'olive', 'maroon', 'yellow'
]
